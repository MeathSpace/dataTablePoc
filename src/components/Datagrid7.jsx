...
const Datagrid7 = () => {
  ...
  const entirepagecsvdataHandler = () => {
    ...
    const link = document.createElement("a");
    link.setAttribute("href", encodedUri);
    link.setAttribute("download", "entire_csv_data.csv");
    document.body.appendChild(link);
  ...
  const applyFilter = (dataArray, filterValue) => {
    return dataArray.filter((item) => {
      return item.LotNo.toLowerCase().includes(filterValue.toLowerCase());
    });
  };
  ...
  const applyFilterByDateRange = (dataArray, startDateValue, endDateValue) => {
    return dataArray.filter((item) => {
      ...
      return (
        (dieReceiptDate >= startDate && dieReceiptDate <= endDate) ||
  ...
  const filteredData =
    filterBy && filterBy !== ""
      ? applyFilter(data, filterBy)
      : applyFilterByDateRange(data, startDate, endDate);
  ...
  const filterEndIndex = Math.min(
    filterStartIndex + dataPerFilterPage,
    filteredData.length,
  );

  // Get data for the current page
  const currentPageFilteredData = filteredData.slice(
    filterStartIndex,
    filterEndIndex,
  );
      ...
      <div className="data7_top_bx">
        ...
        <div>
          ...
          <div className="data7_top_showhide_bx">
            ...
            {showColumn && (
              <div className="data7_top_showhide_bx_content">
                {/* <div>
                ...
                <div>
                  <input
                    type="checkbox"
                    onClick={() => setShowlotno((prev) => !prev)}
                    checked={showlotno}
                  />
                  <p>Lot No.</p>
                </div>
                ...
                <div>
                  <input
                    type="checkbox"
                    onClick={() => setShowdiereceipt((prev) => !prev)}
                    checked={showdiereceipt}
                  />
                  <p>DieReceipt</p>
                </div>
                ...
                <div>
                  <input
                    type="checkbox"
                    onClick={() => setShowBumpIn((prev) => !prev)}
                    checked={showBumpIn}
                  />
                  <p>BumpIn</p>
                </div>
                ...
                <div>
                  <input
                    type="checkbox"
                    onClick={() => setShowBumpOut((prev) => !prev)}
                    checked={showBumpOut}
                  />
                  <p>BumpOut</p>
                </div>
                ...
                <div>
                  <input
                    type="checkbox"
                    onClick={() => setShowProbeIn((prev) => !prev)}
                    checked={showProbeIn}
                  />
                  <p>ProbeIn</p>
                </div>
                ...
                <div>
                  <input
                    type="checkbox"
                    onClick={() => setShowProbeOut((prev) => !prev)}
                    checked={showProbeOut}
                  />
                  <p>ProbeOut</p>
                </div>
                ...
                <div>
                  <input
                    type="checkbox"
                    onClick={() => setShowAssemblyIn((prev) => !prev)}
                    checked={showAssemblyIn}
                  />
                  <p>AssemblyIn</p>
                </div>
                ...
                <div>
                  <input
                    type="checkbox"
                    onClick={() => setShowAssemblyOut((prev) => !prev)}
                    checked={showAssemblyOut}
                  />
                  <p>AssemblyOut</p>
                </div>
                ...
                <div>
                  <input
                    type="checkbox"
                    onClick={() => setShowTestIn((prev) => !prev)}
                    checked={showTestIn}
                  />
                  <p>TestIn</p>
                </div>
                ...
                <div>
                  <input
                    type="checkbox"
                    onClick={() => setShowTestOut((prev) => !prev)}
                    checked={showTestOut}
                  />
                  <p>TestOut</p>
                </div>
                ...
                <div>
                  <input
                    type="checkbox"
                    onClick={() => setShowShipOut((prev) => !prev)}
                    checked={showShipOut}
                  />
                  <p>ShipOut</p>
                </div>
          ...
          <button onClick={removeFilter} className="remove-filter-input">
            <RiDeleteBin6Line />
          </button>

          <button
            className="dwn_crt_csv_data_btn"
          ...
          <button
            className="dwn_crt_entire_data_btn"
        ...
        <div className="data7_content">
          <div className="data7_content_head">
            ...
            {showdiereceipt && (
              <div
                className="data7_content_head_same"
                onClick={() => toggleSortOrder("DieReceipt")}
              >
                <div>
                  <p>DieReceipt</p>
                  {sortBy === "DieReceipt" &&
            ...
            {showday1 && (
              <div
                ...
                onClick={() => toggleSortOrder("day1")}
              >
                <div>
                  <div />
                  {sortBy === "day1" ? (
                    sortOrder === "asc" ? (
                      <div className="data7_arrow">
                        <FaArrowUp />
                      </div>
                    ) : sortOrder === "desc" ? (
                      <div className="data7_arrow">
            ...
            {showBumpIn && (
              <div
                className="data7_content_head_same"
                onClick={() => toggleSortOrder("BumpIn")}
              >
                <div>
                  <p>BumpIn</p>
                  {sortBy === "BumpIn" &&
            ...
            {showBumpOut && (
              <div
                className="data7_content_head_same"
                onClick={() => toggleSortOrder("BumpOut")}
              >
                <div>
                  <p>BumpOut</p>
                  {sortBy === "BumpOut" &&
            ...
            {showProbeIn && (
              <div
                className="data7_content_head_same"
                onClick={() => toggleSortOrder("ProbeIn")}
              >
                <div>
                  <p>ProbeIn</p>
                  {sortBy === "ProbeIn" &&
            ...
            {showProbeOut && (
              <div
                className="data7_content_head_same"
                onClick={() => toggleSortOrder("ProbeOut")}
              >
                <div>
                  <p>ProbeOut</p>
                  {sortBy === "ProbeOut" &&
            ...
            {showAssemblyIn && (
              <div
                className="data7_content_head_same"
                onClick={() => toggleSortOrder("AssemblyIn")}
              >
                <div>
                  <p>AssemblyIn</p>
                  {sortBy === "AssemblyIn" &&
            ...
            {showAssemblyOut && (
              <div
                className="data7_content_head_same"
                onClick={() => toggleSortOrder("AssemblyOut")}
              >
                <div>
                  <p>AssemblyOut</p>
                  {sortBy === "AssemblyOut" &&
            ...
            {showTestIn && (
              <div
                className="data7_content_head_same"
                onClick={() => toggleSortOrder("TestIn")}
              >
                <div>
                  <p>TestIn</p>
                  {sortBy === "TestIn" &&
            ...
            {showTestOut && (
              <div
                className="data7_content_head_same"
                onClick={() => toggleSortOrder("TestOut")}
              >
                <div>
                  <p>TestOut</p>
                  {sortBy === "TestOut" &&
            ...
            {showShipOut && (
              <div
                className="data7_content_head_same"
                onClick={() => toggleSortOrder("ShipOut")}
              >
                <div>
                  <p>ShipOut</p>
                  {sortBy === "ShipOut" &&
          ...
          (startDate && endDate && startDate !== "" && endDate !== "")
            ? currentPageFilteredData.map((t) => (
                <div className="data7_content_body" key={t._id}>
                  {showlotno && (
                    <div className="data7_content_body_same">
                      <div style={{ borderRight: "1px solid black" }}>
                        <p>{t.LotNo}</p>
                      </div>
                    </div>
                  ...
                  {showday1 && (
                    <div className="data7_content_body_diff">
                      <div
                        style={{
                          background:
                  ...
                  {showAssemblyIn && (
                    <div className="data7_content_body_same">
                      <div style={{ background: "var(--bg-color-4)" }}>
                        <p style={{ color: "var(--text-color-4)" }}>
                          {t.AssemblyIn}
                        </p>
                      </div>
                    </div>
                  ...
                  {showTestIn && (
                    <div className="data7_content_body_same">
                      <div style={{ background: "var(--bg-color-5)" }}>
                        <p style={{ color: "var(--text-color-5)" }}>
                          {t.TestIn}
                        </p>
                      </div>
                    </div>
                  ...
                  {showShipOut && (
                    <div className="data7_content_body_same">
                      <div style={{ background: "var(--bg-color-6)" }}>
                        <p style={{ color: "var(--text-color-6)" }}>
                          {t.ShipOut}
                        </p>
                      </div>
                    </div>
        ...
        <div className="data7_pagination">
          ...
          (startDate && endDate && startDate !== "" && endDate !== "") ? (
            <>
                    ...
                    return (
                      <option
                        ...
                        style={{
                          background:
                            optionValue ===
                            `${filterStartIndex + 1} - ${filterEndIndex}`
                              ? "var(--bg-color-2)"
                              : "inherit",
                        }}
                      >
              ...
              <div>
                <button
                  onClick={handlePrevFilterPage}
                  disabled={currentFilterPage === 1}
                >
                  <FaChevronLeft />
                </button>
                <span>
                  {currentFilterPage} of {totalFilterPages}
                </span>
                <button
                  onClick={handleNextFilterPage}
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setCurrentPage(
                      Math.ceil(
                        Number(e.target.value.split(" - ")[0]) / dataPerPage,
                      ),
                    )
                  }
                >
